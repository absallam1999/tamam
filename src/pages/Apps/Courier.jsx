...
const CourierAppPage = () => {
  ...
  const features = [
    ...
    { icon: DollarSign, key: "earnings" },
    { icon: MapPin, key: "routes" },
    { icon: Calendar, key: "schedule" },
    { icon: HeadphonesIcon, key: "support" },
    { icon: Gift, key: "incentives" },
  ];

  const highlights = [
    t("courierApp.highlights.orders"),
    t("courierApp.highlights.earnings"),
    t("courierApp.highlights.routes"),
    t("courierApp.highlights.schedule"),
    t("courierApp.highlights.support"),
  ];

  const stats = [
    {
      value: t("courierApp.stats.couriers"),
      label: t("courierApp.stats.couriersLabel"),
    },
    {
      value: t("courierApp.stats.rating"),
      label: t("courierApp.stats.ratingLabel"),
    },
    {
      value: t("courierApp.stats.earnings"),
      label: t("courierApp.stats.earningsLabel"),
    },
  ];
    ...
    <div style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          <span>{t("courierApp.backToApps")}</span>
        </Link>
        ...
        >
          ...
          >
            ...
            >
              <Truck size={isMobile ? 34 : 46} color="#ffffff" />
              <div
                style={{
                  position: "absolute",
                  inset: 0,
            ...
            >
              <Truck size={isMobile ? 11 : 12} style={{ flexShrink: 0 }} />
              <span>{t("courierApp.hero.badge")}</span>
            </div>
            ...
            >
              ...
              >
                • {t("courierApp.stats.couriers")}{" "}
                {t("courierApp.stats.couriersLabel")} •{" "}
                {t("courierApp.stats.earnings")}{" "}
                {t("courierApp.stats.earningsLabel")}
              </span>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {t("courierApp.hero.downloadAppStore")}
                  </span>
                  <span
                    style={{
            ...
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {t(`courierApp.features.${feature.key}.title`)}
                  </h3>
                  <p
                    style={{
                      fontSize: "clamp(12px, 1.5vw, 13px)",
                  ...
                  >
                    {t(`courierApp.features.${feature.key}.description`)}
                  </p>
                </div>
              );
            })}
